...
object Dependencies {
  ...
  // Import the base Sdk
  const val HUAWEI_COMPUTER_VISION_FACE_ = "com.huawei.hms:ml-computer-vision-face:${Versions.HUAWEI_FACE_SDK_VERSION}"
  ...
  const val KOTLINX_COROUTINES_PLAY_SERVICES = "org.jetbrains.kotlinx:kotlinx-coroutines-play-services:1.1.1"
